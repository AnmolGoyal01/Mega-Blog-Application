        ...
        <div className="container px-4 mx-auto">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 my-4 w-full xl:w-1/5">
              ...
              Welcome to My Blog, your go-to destination for engaging stories, insightful articles, and daily inspiration. Our mission is to create a vibrant community where readers can explore diverse topics, from personal development to lifestyle. Join us as we share knowledge and experiences, one post at a time.
              </p>
            </div>
            ...
            <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
              ...
              <Link
                to="https://github.com/anmolgoyal01"
                target="_main"
                className="inline-flex items-center justify-center h-8 w-8 border border-gray-100 rounded-full mr-1 hover:text-blue-400 hover:border-blue-400"
              >
                <svg
        ...
        <div className="container mx-auto px-4">
          <div className="-mx-4 flex flex-wrap justify-between">
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
              Copyright © 2024 - 2024 Anmol Goyal. All Rights Reserved.
            </div>
            <div className="px-4 w-full text-center sm:w-auto sm:text-left">
              Made with ❤️ by{" "}
